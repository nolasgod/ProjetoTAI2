...
1.0.1 / 2013-09-05
------------------
* removed `LoginPage` field from package.json to remove NPM warning
...
[#2]: https://github.com/jprichardson/node-jsonfile/issues/2      "LoginPage field must be a string url. Deleted."
